...
/***/ function(module, exports) {
	...
	var _user$project$Canvas$totalStars = 30;
	var _user$project$Canvas$gameWidth = 700;
	var _user$project$Canvas$gameHeight = 700;
	var _user$project$Canvas$absoluteToCanvas = function (_p0) {
		var _p1 = _p0;
		return {ctor: '_Tuple2', _0: _p1._0 - (_user$project$Canvas$gameWidth / 2), _1: (_user$project$Canvas$gameHeight / 2) - _p1._1};
	};
	var _user$project$Canvas$gameMargin = 41;
	var _user$project$Canvas$getLocalPosition = function (_p2) {
		var _p3 = _p2;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$toFloat(_p3.x) - _user$project$Canvas$gameMargin,
			_1: _elm_lang$core$Basics$toFloat(_p3.y) - _user$project$Canvas$gameMargin
		};
	};

	var _user$project$Players$Scores = F2(
		function (a, b) {
			return {a: a, b: b};
		});
	var _user$project$Players$B = {ctor: 'B'};
	var _user$project$Players$A = {ctor: 'A'};

	var _user$project$Vector$within = F3(
		function (_p1, radius, _p0) {
			var _p2 = _p1;
			var _p7 = _p2._1;
			var _p6 = _p2._0;
			var _p3 = _p0;
			var _p5 = _p3._1;
			var _p4 = _p3._0;
			return (_elm_lang$core$Native_Utils.cmp(_p6 - radius, _p4) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p4, _p6 + radius) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p7 - radius, _p5) < 1) && (_elm_lang$core$Native_Utils.cmp(_p5, _p7 + radius) < 1)));
		});
	var _user$project$Vector$distance = F2(
		function (_p9, _p8) {
			var _p10 = _p9;
			var _p11 = _p8;
			return _elm_lang$core$Basics$sqrt(
				Math.pow(_p11._0 - _p10._0, 2) + Math.pow(_p11._1 - _p10._1, 2));
		});
	var _user$project$Vector$angle = F2(
		function (_p13, _p12) {
			var _p14 = _p13;
			var _p15 = _p12;
			return A2(_elm_lang$core$Basics$atan2, _p15._1 - _p14._1, _p15._0 - _p14._0);
		});
	var _user$project$Vector$orientation = F3(
		function (_p18, _p17, _p16) {
			...
			var _p22 = _p20._0;
			var _p21 = _p16;
			var val = ((_p23 - _p19._1) * (_p21._0 - _p22)) - ((_p22 - _p19._0) * (_p21._1 - _p23));
			return _elm_lang$core$Native_Utils.eq(val, 0) ? 0 : ((_elm_lang$core$Native_Utils.cmp(val, 0) > 0) ? 1 : 2);
		});
	var _user$project$Vector$onSegment = F3(
		function (_p26, _p25, _p24) {
			...
			return (_elm_lang$core$Native_Utils.cmp(
				_p32,
				A2(_elm_lang$core$Basics$max, _p34, _p30)) < 1) && ((_elm_lang$core$Native_Utils.cmp(
				_p32,
				A2(_elm_lang$core$Basics$min, _p34, _p30)) > -1) && ((_elm_lang$core$Native_Utils.cmp(
				_p33,
				A2(_elm_lang$core$Basics$max, _p35, _p31)) < 1) && (_elm_lang$core$Native_Utils.cmp(
				_p33,
				A2(_elm_lang$core$Basics$min, _p35, _p31)) > -1)));
		});
	var _user$project$Vector$intersect = F2(
		function (_p37, _p36) {
			var _p38 = _p37;
			var _p43 = _p38._1;
			var _p42 = _p38._0;
			...
			var _p41 = _p39._1;
			var _p40 = _p39._0;
			var o4 = A3(_user$project$Vector$orientation, _p40, _p41, _p43);
			var o3 = A3(_user$project$Vector$orientation, _p40, _p41, _p42);
			var o2 = A3(_user$project$Vector$orientation, _p42, _p43, _p41);
			var o1 = A3(_user$project$Vector$orientation, _p42, _p43, _p40);
			return ((!_elm_lang$core$Native_Utils.eq(o1, o2)) && (!_elm_lang$core$Native_Utils.eq(o3, o4))) || ((_elm_lang$core$Native_Utils.eq(o1, 0) && A3(_user$project$Vector$onSegment, _p42, _p40, _p43)) || ((_elm_lang$core$Native_Utils.eq(o2, 0) && A3(_user$project$Vector$onSegment, _p42, _p41, _p43)) || ((_elm_lang$core$Native_Utils.eq(o3, 0) && A3(_user$project$Vector$onSegment, _p40, _p42, _p41)) || (_elm_lang$core$Native_Utils.eq(o4, 0) && A3(_user$project$Vector$onSegment, _p40, _p43, _p41)))));
		});
	var _user$project$Vector$move = F2(
		function (_p45, _p44) {
			var _p46 = _p45;
			var _p47 = _p44;
			return {ctor: '_Tuple2', _0: _p47._0 + _p46._0, _1: _p47._1 + _p46._1};
		});
	var _user$project$Vector$rotate = F2(
		function (theta, _p48) {
			...
			return {
				ctor: '_Tuple2',
				_0: (_p50 * _elm_lang$core$Basics$cos(theta)) - (_p51 * _elm_lang$core$Basics$sin(theta)),
				_1: (_p50 * _elm_lang$core$Basics$sin(theta)) + (_p51 * _elm_lang$core$Basics$cos(theta))
			};
		});
	var _user$project$Vector$scale = F2(
		function (factor, _p52) {
			var _p53 = _p52;
			return {ctor: '_Tuple2', _0: _p53._0 * factor, _1: _p53._1 * factor};
		});
	var _user$project$Vector$toInt = function (_p54) {
		var _p55 = _p54;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$round(_p55._0),
			_1: _elm_lang$core$Basics$round(_p55._1)
		};
	};

	var _user$project$Diamond$diamondColour = F2(
		function (isOverlap, player) {
			if (isOverlap) {
				...
				if (_p0.ctor === 'A') {
					return A3(
						_elm_lang$core$Color$hsl,
						_elm_lang$core$Basics$degrees(349),
						1,
						0.5);
				} else {
					return A3(
						_elm_lang$core$Color$hsl,
						_elm_lang$core$Basics$degrees(55),
						1,
						0.5);
				}
			}
		});
	var _user$project$Diamond$any2 = F3(
		function (f, xs, ys) {
			return A2(
				_elm_lang$core$List$any,
				function (x) {
	...
	var _user$project$Diamond$points = function (_p1) {
		var _p2 = _p1;
		var _p4 = _p2.start;
		var _p3 = _p2.end;
		return A2(
			_elm_lang$core$List$map,
			_user$project$Vector$move(
				_user$project$Canvas$absoluteToCanvas(_p4)),
			A2(
				_elm_lang$core$List$map,
				_user$project$Vector$rotate(
					0 - A2(_user$project$Vector$angle, _p4, _p3)),
				A2(
					_elm_lang$core$List$map,
					_user$project$Vector$scale(
						A2(_user$project$Vector$distance, _p4, _p3)),
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 0, _1: 0},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 0.7, _1: 0.25},
							_1: {
								ctor: '::',
	...
	var _user$project$Diamond$edges = function (diamond) {
		var _p5 = _user$project$Diamond$points(diamond);
		if (((((_p5.ctor === '::') && (_p5._1.ctor === '::')) && (_p5._1._1.ctor === '::')) && (_p5._1._1._1.ctor === '::')) && (_p5._1._1._1._1.ctor === '[]')) {
			var _p9 = _p5._1._1._1._0;
			var _p8 = _p5._1._1._0;
			var _p7 = _p5._1._0;
			var _p6 = _p5._0;
			return {
				ctor: '::',
	...
	var _user$project$Diamond$overlap = F2(
		function (a, b) {
			return A3(
				_user$project$Diamond$any2,
				F2(
					function (x, y) {
						return _elm_lang$core$Native_Utils.eq(
							_user$project$Vector$toInt(x),
							_user$project$Vector$toInt(y));
					}),
				_user$project$Diamond$points(a),
				_user$project$Diamond$points(b)) || A3(
				_user$project$Diamond$any2,
				_user$project$Vector$intersect,
				_user$project$Diamond$edges(a),
				_user$project$Diamond$edges(b));
		});
	var _user$project$Diamond$draw = function (_p10) {
		var _p11 = _p10;
		return A2(
			_evancz$elm_graphics$Collage$outlined,
			_evancz$elm_graphics$Collage$solid(
				A2(_user$project$Diamond$diamondColour, _p11.overlaps, _p11.player)),
			_evancz$elm_graphics$Collage$polygon(
				_user$project$Diamond$points(_p11)));
	};
	var _user$project$Diamond$Diamond = F4(
		function (a, b, c, d) {
			return {start: a, end: b, overlaps: c, player: d};
		});

	var _user$project$Star$starColour = F2(
		function (isOver, isSelected) {
			return isSelected ? A3(
				...
				0.3) : A3(
				_elm_lang$core$Color$hsl,
				_elm_lang$core$Basics$degrees(250),
				1,
				0.5));
		});
	var _user$project$Star$hoverRadius = 8;
	var _user$project$Star$starRadius = 5;
	var _user$project$Star$draw = F2(
		function (mousePos, star) {
			var isOver = A3(_user$project$Vector$within, star.center, _user$project$Star$hoverRadius, mousePos);
			return A2(
				_evancz$elm_graphics$Collage$move,
				_user$project$Canvas$absoluteToCanvas(star.center),
				A2(
					_evancz$elm_graphics$Collage$filled,
					A2(_user$project$Star$starColour, isOver, star.selected),
					_evancz$elm_graphics$Collage$circle(_user$project$Star$starRadius)));
		});
	var _user$project$Star$Star = F2(
		function (a, b) {
			return {center: a, selected: b};
		});

	var _user$project$Game$possibleDiamondAt = F3(
		function (currentPlayer, start, end) {
			return A2(
				_elm_lang$core$Maybe$map,
				function (s) {
					return _user$project$Diamond$draw(
						{start: s, end: end, overlaps: false, player: currentPlayer});
				},
				start);
		});
	var _user$project$Game$background = A2(
		_evancz$elm_graphics$Collage$gradient,
		A3(
			_elm_lang$core$Color$linear,
			{ctor: '_Tuple2', _0: 0, _1: _user$project$Canvas$gameHeight / 2},
			{ctor: '_Tuple2', _0: 0, _1: (0 - _user$project$Canvas$gameHeight) / 2},
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 0.6,
					_1: A3(_elm_lang$core$Color$hsl, 0, 0, 0)
				},
				_1: {
					ctor: '::',
					_0: {
		...
		A2(_evancz$elm_graphics$Collage$rect, _user$project$Canvas$gameHeight, _user$project$Canvas$gameWidth));
	var _user$project$Game$game = function (model) {
		return _evancz$elm_graphics$Element$toHtml(
			A3(
				_evancz$elm_graphics$Collage$collage,
				_user$project$Canvas$gameHeight,
				_user$project$Canvas$gameWidth,
					...
					A2(
						...
						_elm_lang$core$Basics$identity,
						{
							...
							_0: _elm_lang$core$Maybe$Just(
								{
									ctor: '::',
									_0: _user$project$Game$background,
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$List$map,
										_user$project$Star$draw(model.position),
										model.stars)),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Maybe$Just(
										A2(_elm_lang$core$List$map, _user$project$Diamond$draw, model.diamonds)),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$core$Maybe$map,
											_elm_lang$core$List$singleton,
											A3(_user$project$Game$possibleDiamondAt, model.currentPlayer, model.diamondStart, model.position)),
										_1: {ctor: '[]'}
									}
								}
							}
	...
	var _user$project$Game$overlappedDiamonds = function (diamond) {
		return _elm_lang$core$List$map(
			function (x) {
				return _elm_lang$core$Native_Utils.update(
					x,
					{
						overlaps: A2(_user$project$Diamond$overlap, diamond, x)
					});
			});
	};
	var _user$project$Game$clickedStar = F2(
		function (clickPos, stars) {
			return _elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (star) {
						return A3(
							_user$project$Vector$within,
							star.center,
							_user$project$Star$hoverRadius,
							_user$project$Canvas$getLocalPosition(clickPos));
					},
					stars));
		});
	var _user$project$Game$tooClose = F2(
		function (_p0, stars) {
			var _p1 = _p0;
			var _p3 = _p1._1;
			var _p2 = _p1._0;
			...
			return A2(
				_elm_lang$core$List$any,
				function (star) {
					return A3(_user$project$Vector$within, star.center, minDistance, _p1);
				},
				stars) || ((_elm_lang$core$Native_Utils.cmp(_p2, margin) < 0) || ((_elm_lang$core$Native_Utils.cmp(_p2, _user$project$Canvas$gameWidth - margin) > 0) || ((_elm_lang$core$Native_Utils.cmp(_p3, margin) < 0) || (_elm_lang$core$Native_Utils.cmp(_p3, _user$project$Canvas$gameHeight - margin) > 0))));
		});
	var _user$project$Game$randomPoint = A2(
		_elm_lang$core$Random$pair,
		A2(_elm_lang$core$Random$float, 0, _user$project$Canvas$gameWidth),
		A2(_elm_lang$core$Random$float, 0, _user$project$Canvas$gameHeight));
	var _user$project$Game$turnTime = 30;
	var _user$project$Game$endTurn = F2(
		function (score, model) {
			var _p4 = model.currentPlayer;
			if (_p4.ctor === 'A') {
				return _elm_lang$core$Native_Utils.update(
					model,
					{playerA: model.playerA + score, currentPlayer: _user$project$Players$B, timer: _user$project$Game$turnTime});
			} else {
				return _elm_lang$core$Native_Utils.update(
					model,
					{playerB: model.playerB + score, currentPlayer: _user$project$Players$A, timer: _user$project$Game$turnTime});
			}
		});
	var _user$project$Game$Model = F9(
		function (a, b, c, d, e, f, g, h, i) {
			return {diamondStart: a, position: b, stars: c, diamonds: d, playerA: e, playerB: f, currentPlayer: g, timer: h, state: i};
		});
	var _user$project$Game$Draw = {ctor: 'Draw'};
	var _user$project$Game$Won = function (a) {
		return {ctor: 'Won', _0: a};
	};
	var _user$project$Game$winner = F2(
		function (playerA, playerB) {
			return (_elm_lang$core$Native_Utils.cmp(playerA, playerB) > 0) ? _user$project$Game$Won(_user$project$Players$A) : ((_elm_lang$core$Native_Utils.cmp(playerB, playerA) > 0) ? _user$project$Game$Won(_user$project$Players$B) : _user$project$Game$Draw);
		});
	var _user$project$Game$Skipped = {ctor: 'Skipped'};
	var _user$project$Game$Playing = {ctor: 'Playing'};
	var _user$project$Game$isPlaying = function (state) {
		return _elm_lang$core$Native_Utils.eq(state, _user$project$Game$Playing) || _elm_lang$core$Native_Utils.eq(state, _user$project$Game$Skipped);
	};
	var _user$project$Game$scores = function (model) {
		return A2(
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Turn Time'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(model.timer)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					...
					_0: A2(
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'active',
											_1: _elm_lang$core$Native_Utils.eq(model.currentPlayer, _user$project$Players$A) && _user$project$Game$isPlaying(model.state)
										},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Player A'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(model.playerA)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
						...
						_0: A2(
									...
									_0: _elm_lang$html$Html_Attributes$classList(
										{
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'active',
												_1: _elm_lang$core$Native_Utils.eq(model.currentPlayer, _user$project$Players$B) && _user$project$Game$isPlaying(model.state)
											},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Player B'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_elm_lang$core$Basics$toString(model.playerB)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
	...
	var _user$project$Game$NotStarted = {ctor: 'NotStarted'};
	var _user$project$Game$model = {
		diamondStart: _elm_lang$core$Maybe$Nothing,
		position: {ctor: '_Tuple2', _0: 0, _1: 0},
		stars: {ctor: '[]'},
		diamonds: {ctor: '[]'},
		playerA: 0,
		playerB: 0,
		currentPlayer: _user$project$Players$A,
		timer: _user$project$Game$turnTime,
		state: _user$project$Game$NotStarted
	};
	var _user$project$Game$start = _elm_lang$core$Native_Utils.update(
		_user$project$Game$model,
		{state: _user$project$Game$Playing});
	var _user$project$Game$StartGame = {ctor: 'StartGame'};
	var _user$project$Game$overlay = function (model) {
		var _p5 = model.state;
		switch (_p5.ctor) {
			case 'NotStarted':
				return {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Game$StartGame),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Click to play'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Player A Won'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Click to play again'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Player B Won'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('It was a Draw'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					_elm_lang$core$List$concat(
						{
							ctor: '::',
							_0: _user$project$Game$overlay(model),
							_1: {
								ctor: '::',
								_0: {
									ctor: '::',
									_0: _user$project$Game$game(model),
									_1: {ctor: '[]'}
								},
								_1: {ctor: '[]'}
							}
				...
				_1: {
					ctor: '::',
					_0: _user$project$Game$scores(model),
					_1: {ctor: '[]'}
				}
			});
	};
	...
	var _user$project$Game$AddStar = function (a) {
		return {ctor: 'AddStar', _0: a};
	};
	var _user$project$Game$init = {
		ctor: '_Tuple2',
		_0: _user$project$Game$model,
		_1: A2(_elm_lang$core$Random$generate, _user$project$Game$AddStar, _user$project$Game$randomPoint)
	};
		...
		function (msg, model) {
			...
			switch (_p7.ctor) {
				case 'StartGame':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_user$project$Game$start,
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Random$generate, _user$project$Game$AddStar, _user$project$Game$randomPoint),
							_1: {ctor: '[]'}
						});
				case 'MouseClick':
					var selectedStar = A2(
						...
						A2(_user$project$Game$clickedStar, _p7._0, model.stars));
					var _p8 = {ctor: '_Tuple2', _0: model.diamondStart, _1: selectedStar};
					if (_p8._0.ctor === 'Just') {
						if (_p8._1.ctor === 'Just') {
							var _p10 = _p8._1._0;
							var _p9 = _p8._0._0;
							return A2(
								...
								A2(
									_user$project$Game$overlappedDiamonds,
									A4(_user$project$Diamond$Diamond, _p9, _p10, false, model.currentPlayer),
									model.diamonds)) ? A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model,
								{ctor: '[]'}) : A2(
								...
								A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											...
											diamonds: {
												ctor: '::',
												_0: A4(_user$project$Diamond$Diamond, _p9, _p10, false, model.currentPlayer),
												_1: model.diamonds
											}
										})),
								{ctor: '[]'});
				...
				case 'MouseMove':
					var _p12 = _p7._0;
					var _p11 = model.diamondStart;
					if (_p11.ctor === 'Just') {
						var drawDiamond = function (pos) {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									position: pos,
									diamonds: A2(
										_user$project$Game$overlappedDiamonds,
										A4(_user$project$Diamond$Diamond, _p11._0, pos, false, model.currentPlayer),
										model.diamonds)
								});
						};
						var selectedStar = A2(
							...
							A2(_user$project$Game$clickedStar, _p12, model.stars));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							drawDiamond(
								A2(
									_elm_lang$core$Maybe$withDefault,
									_user$project$Canvas$getLocalPosition(_p12),
									selectedStar)),
							{ctor: '[]'});
					} else {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									position: _user$project$Canvas$getLocalPosition(_p12)
								}),
							{ctor: '[]'});
					}
				case 'AddStar':
					var _p13 = _p7._0;
					return A2(_user$project$Game$tooClose, _p13, model.stars) ? A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{
							ctor: '::',
						...
						_elm_lang$core$List$length(model.stars),
						_user$project$Canvas$totalStars) < 0) ? A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								stars: {
									ctor: '::',
									_0: A2(_user$project$Star$Star, _p13, false),
									_1: model.stars
								}
							}),
						{
						...
						{ctor: '[]'}));
				default:
					return _elm_lang$core$Native_Utils.eq(model.timer, 0) ? (_elm_lang$core$Native_Utils.eq(model.state, _user$project$Game$Skipped) ? A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								state: A2(_user$project$Game$winner, model.playerA, model.playerB)
							}),
						{ctor: '[]'}) : A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{diamondStart: _elm_lang$core$Maybe$Nothing, state: _user$project$Game$Skipped})),
						{ctor: '[]'})) : A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
	...
	var _user$project$Game$MouseMove = function (a) {
		return {ctor: 'MouseMove', _0: a};
	};
	var _user$project$Game$MouseClick = function (a) {
		return {ctor: 'MouseClick', _0: a};
	};
	var _user$project$Game$subscriptions = function (model) {
		return _user$project$Game$isPlaying(model.state) ? _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$clicks(_user$project$Game$MouseClick),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$moves(_user$project$Game$MouseMove),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Game$Tick),
						_1: {ctor: '[]'}
					}
				}
